...
--------------------------------------------------------
-- DIGITAL LIBRARY DATABASE (FULL PROFESSIONAL VERSION)
-- Supports: Borrowing, Multi-Cart Purchase, Login, Hashing
--------------------------------------------------------
...
--------------------------------------------------------
-- OPTIONAL EXAMPLE DATA (REMOVE IF NOT NEEDED)
--------------------------------------------------------
--INSERT INTO USERS (FIRSTNAME, LASTNAME, USERNAME, PASSWORD, ROLE)
--VALUES ('Admin','Manager','manager1','HASHED_PASS_HERE','Manager');

--INSERT INTO USERS (FIRSTNAME, LASTNAME, USERNAME, PASSWORD, ROLE)
--VALUES ('Staff','Employee','employee1','HASHED_PASS_HERE','Employee');

--INSERT INTO USERS (FIRSTNAME, LASTNAME, USERNAME, PASSWORD, ROLE)
--VALUES ('John','Customer','john123','HASHED_PASS_HERE','Customer');
